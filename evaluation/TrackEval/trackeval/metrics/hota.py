...
class HOTA(_BaseMetric):
    ...
    def __init__(self, config=None):
        ...
        # self.array_labels = np.arange(0.01, 0.25, 0.01)
    ...
    def eval_sequence(self, data):
        ...
        global_alignment_score = potential_matches_count / (
            gt_id_count+ tracker_id_count - potential_matches_count + 1e-6)
        ...
        for t, (gt_ids_t, tracker_ids_t) in enumerate(zip(data['gt_ids'], data['tracker_ids'])):
            ...
            match_rows, match_cols = linear_sum_assignment(1-score_mat)
            ...
            for a, alpha in enumerate(self.array_labels):
                ...
                num_matches = len(alpha_match_cols)
                # print(f'col:{len(alpha_match_cols)}')
                # print(f'col:{len(alpha_match_rows)}')
